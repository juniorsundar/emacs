...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               (linum :inherit default :foreground ,ctp-overlay1 :background ,ctp-base)
               (line-number :inherit default :foreground ,ctp-overlay1 :background ,ctp-base)
               (line-number-current-line :inherit line-number :foreground ,ctp-text)
               ...
               (shadow :foreground ,ctp-overlay1)
